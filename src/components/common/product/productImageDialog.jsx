    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          >
            <Typography sx={{ fonSize: "18px", fontWeight: 600 }}>
              {" "}
              Images and video product
            </Typography>
          ...
          <Box sx={{ p: 2 }}>
            <Box>
              ...
              <Typography
                ...
                sx={{ mt: 2, color: "gray", fontSize: "10px" }}
              >
                Sizes that are not allowed (100px height * 250px width) are of the type (jpg, jpeg,
                png, gif) and do not exceed 5 megabytes per image, with a maximum of 10 images.
              </Typography>
            </Box>
            {/* button choose image */}
