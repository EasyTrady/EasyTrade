...
export default function ResponsiveGrid () {
  ...
  return (
    ...
    fontWeight: { md:600, lg:500}, textAlign: 'center', color: '#3D2D66', lineHeight:'52.5px'}}>
        الخدمات المقدمه
      </Typography>
      <Typography sx={{ fontFamily: 'Cairo', fontSize:{md:'16px', lg:'18px'}, fontWeight: 400, textAlign: 'center', color: '#505050',lineHeight:'30px' }}>
