...
import { Avatar, Container, InputLabel, FormControlLabel, Switch, RadioGroup, Radio,FormLabel, Paper, Box, Tooltip, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, FormControl, Icon, MenuItem, Select, TextField, Typography, Autocomplete, ListItemText, Chip } from '@mui/material';
            ...
            <Container sx={{ p: 2 }}>
                <SoftBox color="inherit" mb={{ xs: 1, md: 0 }} sx={(theme) => navbarRow(theme, { isMini })}>
                 ...
                 <Form component="form"
                    ...
                    <Box sx={{ marginY: "6px" }}>
                            <InputLabel htmlFor="outlined-adornment-email-register" sx={{ marginY: "6px", fontSize: "14px" }}>{t("name*")}</InputLabel>
                            <SoftInput
                        ...
                        <Box>
                         ...
                         <Box sx={{ marginY: "6px" }}>
                            <InputLabel htmlFor="outlined-adornment-email-register" sx={{ marginY: "6px", fontSize: "14px" }}>{t("amount")}</InputLabel>
                                <SoftInput
                ...
                <Form component="form"
                    ...
                    }} sx={{ width: "100%", borderRadius: "8px", my: "24px" }} hideFooter={true}>
                    <Box sx={{ display: "flex", flexDirection: "column", boxSizing: "border-box" }}>
                        {/* <Box sx={{ marginY: "6px" }}>
                        ...
                        <Box sx={{ marginY: "6px" }}>
                            <InputLabel htmlFor="outlined-adornment-email-register" sx={{ fontSize: "14px" }}>{t("Minimum requirement*")}</InputLabel>
                            <RadioGroup
                                row
                                aria-labelledby="demo-row-radio-buttons-group-label"
                                name="row-radio-buttons-group"
                            ...
                            sx={{ ".MuiInputBase-root": { overflow: "hidden !important"} }}
                            onChange={(e) => {
                                controls.minimumrequirement=="minimumpurchaseamount"? setControl("minimum_items_quantity", e.target.value):setControl("minimum_purchase_amount", e.target.value)
                            }}
                           />
                            }
                        </Box>
