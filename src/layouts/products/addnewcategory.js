...
function Addnewcategory({ absolute, light, isMini }) {
  ...
  const [categoryPostRequest, postcategoryResponce] = useRequest({
    path: CATEGORY,
    method: "post",
    Token: `Token ${Token}`,
  ...
  const [categorypatchRequest, patchcategoryResponce] = useRequest({
    path: CATEGORY,
    method: "patch",
    Token: `Token ${Token}`,
    successMessage: t("postCategoryresult"),
  ...
  return (
    <DashboardLayout>
      ...
      <Container maxWidth={false} sx={{ p: 4 }}>
          ...
          >
            ...
            <SoftBox sx={{ display: "flex", flexDirection: "column" }}>
              ...
              >
                ...
                <Typography
                  variant={"p"}
                  sx={{ color: (theme) => theme.palette.purple.middle, marginX: "8px" }}
                >
                  {t("UploadcategoryPhoto")}
                </Typography>
              </SoftButton>
              <SoftBox>
                <Typography variant={"span"} sx={{ fontWeight: "700", fontSize: "14px" }}>
                  {t("Remember")}
                </Typography>
                <Typography
                  variant={"span"}
          ...
          >
            ...
            <Box sx={{ marginY: "6px" }}>
              ...
              <RadioGroup
                ...
                onChange={(e) => {
                  setControl("is_root_node", e.target.value);
                }}
              >
                <FormControlLabel
                  value={true}
        ...
        {controls.is_root_node == "false" || controls.is_root_node == false ? (
          <SoftBox sx={{ position: "relative" }}>
            ...
            <SoftBox
              sx={{
                backgroundColor: (theme) => theme.palette.white.main,
                borderRadius: "8px",
                margin: { lg: "24px", md: "24px", sm: "24px", xs: "0px" },
                display: "flex",
            ...
            >
              <Typography
                sx={{ fonSize: { lg: "18px", md: "18px", sm: "14px", xs: "14px" } }}
                variant="p"
              >
                {controls.name}
              </Typography>
            ...
            >
              <Box>
                ...
                <SoftInput
                  ...
                  onChange={(e) => {
                    setControl("parent", e.target.value);
                    formDate?.append("parent", e.target.value);
                  }}
